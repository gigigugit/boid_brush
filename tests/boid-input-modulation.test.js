...
function run(matrix, { params, features = {}, rawFeatures, capabilities = ALL_CAPS }) {
  const evaluation = evaluateModMatrix({ matrix, features: { constant: 1, ...features }, rawFeatures, capabilities });

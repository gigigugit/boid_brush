...
export class App {
  ...
  getP() {
    ...
    this._cachedP = {
      ...
      lbmSpawnCount: numOr('lbmSpawnCount', 16),
      lbmParticleRadius: numOr('lbmParticleRadius', 3),
      lbmViscosity: numOr('lbmViscosity', 76) / 100,
      ...
      lbmMotionDecay: numOr('lbmMotionDecay', 62) / 100,
      lbmStopSpeed: numOr('lbmStopSpeed', 24) / 100,
      lbmPigmentCarry: numOr('lbmPigmentCarry', 52) / 100,
      ...
      lbmStrokeRake: numOr('lbmStrokeRake', 18) / 100,
      lbmStrokeJitter: numOr('lbmStrokeJitter', 14) / 100,

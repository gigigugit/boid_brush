...
export class App {
  ...
  getP() {
    ...
    this._cachedP = {
      ...
      // Respawn events
      spawnEventHover: sel('spawnEventHover') || 'spawn',
      spawnEventTouch: sel('spawnEventTouch') || 'spawn',
      spawnEventUntouch: sel('spawnEventUntouch') || 'cull',
      spawnEventUnhover: sel('spawnEventUnhover') || 'cull',
      // Swarm
      count: val('count') || 60,
      // Forces
      seek: val('seek') / 100,

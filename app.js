...
export class App {
  ...
  getP() {
    ...
    this._cachedP = {
      ...
      lbmSpawnCount: numOr('lbmSpawnCount', 24),
      lbmParticleRadius: numOr('lbmParticleRadius', 3),
      lbmViscosity: numOr('lbmViscosity', 68) / 100,
      lbmDensity: numOr('lbmDensity', 42) / 100,
      lbmSurfaceTension: numOr('lbmSurfaceTension', 38) / 100,
      lbmTimeStep: numOr('lbmTimeStep', 12) / 16,
      lbmSubsteps: numOr('lbmSubsteps', 2),
      lbmMotionDecay: numOr('lbmMotionDecay', 42) / 100,
      lbmStopSpeed: numOr('lbmStopSpeed', 18) / 100,
      lbmResolutionScale: numOr('lbmResolutionScale', 100) / 100,
      lbmFluidScale: numOr('lbmFluidScale', 100) / 100,
      lbmStrokePull: numOr('lbmStrokePull', 42) / 100,
      lbmStrokeRake: numOr('lbmStrokeRake', 14) / 100,
      lbmStrokeJitter: numOr('lbmStrokeJitter', 10) / 100,

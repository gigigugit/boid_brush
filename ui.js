...
export function buildSidebar(app) {
  ...
  sb.innerHTML = `
    ...
    <div class="section-body" data-brushes="fluid">
      ...
      ${sliderRow('fluidViscosity', 'Viscosity', 0, 100, 45, v => (v / 100).toFixed(2), 'Blend nearby droplet velocities into a smoother flow')}
    ...
    <div class="section-body collapsed" data-brushes="fluid">
      ...
      ${sliderRow('fluidSpread', 'Spread', 0, 100, 18, null, 'Random turbulence mixed into the flow')}

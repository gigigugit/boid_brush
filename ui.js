...
export function buildSidebar(app) {
  ...
  sb.innerHTML = `
    ...
    <div class="section-body" data-brushes="blob">
      ...
      ${sliderRow('blobResolution', 'Resolution', 16, 96, 48, null, 'Internal bitmap resolution used for each blob stamp')}
      ${sliderRow('blobSoftness', 'Mask Softness', 0, 100, 35, v => (v / 100).toFixed(2), 'Softens the outer blob silhouette generated by the local mask model')}
